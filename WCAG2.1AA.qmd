...
Includes **2.1 level AA** guidelines [only]{.underline}. These are the guidelines that need to be met for all content created as part of this project. 

# Principle 1 - Perceivable

Information and user interface components must be presentable to useres in ways they can perceive.
...
-   **1.3.4 Orientation:** Content does ont restrict its view and operation to a single display orientation, such as portrait or landscape, unless a specific display orientation is essential.
...
Information and the operation of the user interface mst be understandable.
