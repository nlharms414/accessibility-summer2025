...
![](images/popvssamp_1.png){fig-alt="Large circle labeled 'Population' containing figures and a smaller circle labeled 'Sample' containing a subset of figures from the large circle."}
...
::: {.column width="60%"}
![](images/applet_1.png){width="110%" height="110%" fig-alt="Dot plot where each dot represents one set of 16 attempts by Buzz. Dots form a mound shape between 3 and 11 that peaks between 7 and 8."}
:::
:::::