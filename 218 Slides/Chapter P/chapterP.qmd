...
::::: columns
::: {.column width="35%"}
<br> ![](Chapter%20P%20Slide%20Images/baby.png){fig-alt="Angry baby"}
...
## Four Pillars of Statistical Evidence
...
![](Chapter%20P%20Slide%20Images/nadotplot.png){fig-alt="Dot plot of National Anthem length in seconds. Outliers include a dot at 64 seconds and dots at 154 and 156 seconds."}
...
::: {.column width="60%"}
![Histogram of song length](Chapter%20P%20Slide%20Images/nahist.png){fig-alt="Histogram of National Anthem length in seconds. Outliers are Neil Diamond between 60 and 70 seconds, and Natalie Cole and Alicia Keys between 150 and 160 seconds. The mean is 108.03 seconds with a standard deviation of 19.17 seconds."}
:::
:::::
...
## Cars vs. Goats Exploration {style="font-size: 35px"}
...
::: {.column width="40%"}
![](Chapter%20P%20Slide%20Images/goat.jpg){width="110%" height="110%" fig-alt="Goat lying down with caption 'Don't worry you goat this.'"}
:::
:::::
